...
def run_evaluation_report(config_path="configs/base_config.yaml", weights_path=None):
    ...
    ece_val, ece_levels, ece_coverage = compute_regression_ece(
        rgb_preds, rgb_scales, rgb_targets, return_curve=True
    )
    ...
    # Real reliability diagram: nominal confidence level vs. measured empirical
    # coverage, computed over the validation set (not a synthetic curve).
