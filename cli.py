...
def main():
    ...
    if args.command == "train-stage1":
        ...
        # Latency profiling (SUTRAMInferencePipeline is imported at module scope;
        # a local re-import here would shadow it and make the name function-local,
        # breaking the export/infer branches with UnboundLocalError).
        ...
        if os.path.exists(lr_tir_path) and os.path.exists(ref_path):
            ...
            lr_norm = calibrate_thermal_to_norm(lr_img)  # -> normalized BT [0,1]
