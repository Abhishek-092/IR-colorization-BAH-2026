# Project SUTRAM End-to-End Phased Training Runbook
...
Write-Host "Training complete. Checkpoints saved under experiments/sutram_baseline/checkpoints/" -ForegroundColor Green
