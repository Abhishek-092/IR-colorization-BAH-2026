...
# Insert root directory into sys.path so the script can be run standalone
# (matches cli.py / data_pipeline/prepare_dataset.py) — without this the
# `training` package is not importable and the script fails immediately.
